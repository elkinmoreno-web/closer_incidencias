...
async function carpetaDelMes(categoria: 'Incidencias' | 'Ausencias' | 'Conexiones' | 'Fichas' | 'Reclamaciones'): Promise<string> {
...
export async function subirArchivoDrive(
  categoria: 'Incidencias' | 'Ausencias' | 'Conexiones' | 'Fichas' | 'Reclamaciones',
